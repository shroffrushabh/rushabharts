...
--
-- Host: localhost
-- Generation Time: Jun 06, 2012 at 06:44 PM
...
INSERT INTO `cc_applog` (`logRecordId`, `applicationId`, `referrer`, `referrerData`, `queryStringData`, `type`, `source`, `message`, `stackTrace`, `exceptionType`, `appLayer`, `createdBy`, `createdOn`, `deviceId`, `deviceOS`, `apiVersion`, `JSONRequest`, `errorCode`) VALUES
(1, 1, ' ', ' ', ' ', ' ', '/Applications/XAMPP/xamppfiles/htdocs/igcserv', 'User with email Id already exists.', '#0 /Applications/XAMPP/xamppfiles/htdocs/igcserver_v01/Membership/MembershipWS.php(102): UserManager->createUser(Object(UserDetails))\n#1 {main}', ' ', ' ', '0', '2012-06-06 23:55:31', ' ', ' ', ' ', '{"userName":"sachin@sachin.com","pwd":"sachin","applicationId":"1","method":"createUser","deviceId":"","deviceOs":"","apiVersion":"","params":[{"passwordQuestion":"sachin","passwordAnswer":"sachin","firstName":"sachin","lastName":"sachin","city":"sachin","country":"sachin","zipCode":"400063","specia', '100');
...
(8, 1, 'isrkadam', 0, '', 'q', 'a', '2012-06-06 23:55:31', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2012-05-27 21:15:13', '2012-05-27 21:15:13', 'md5'),
(11, 1, '15285722f9def45c091725aee9c387cb', 2, 'NA', 'Q', 'A', '2012-06-06 23:55:31', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2012-05-27 21:31:51', '2012-05-27 21:31:51', 'md5'),
(12, 1, '098f6bcd4621d373cade4e832627b4f6', 2, 'NA', 'test', 'test', '2012-06-06 23:55:31', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2012-06-04 22:08:28', '2012-06-04 22:08:28', 'md5'),
(13, 1, '5a105e8b9d40e1329780d62ea2265d8a', 2, 'NA', 'test1', 'test1', '2012-06-06 23:55:31', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2012-06-04 22:09:59', '2012-06-04 22:09:59', 'md5'),
(14, 1, '15285722f9def45c091725aee9c387cb', 2, 'NA', 'sachin', 'sachin', '2012-06-06 23:55:31', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2012-06-06 23:41:34', '2012-06-06 23:41:34', 'md5');
...
(12, 1, 'test', 'test', 'test', 'test', '400063', 1, 1, '2012-06-04 22:08:28', '2012-06-04 22:08:28'),
(13, 1, 'test1', 'test1', 'test1', 'test1', '400063', 1, 1, '2012-06-04 22:09:59', '2012-06-04 22:09:59'),
(14, 1, 'sachin', 'sachin', 'sachin', 'sachin', '400063', 1, 1, '2012-06-06 23:41:34', '2012-06-06 23:41:34');
...
(12, 1, 'test test', 'test@test.com', '2012-06-04 22:08:28', '2012-06-04 22:08:28'),
(13, 1, 'test1 test1', 'test1@test.com', '2012-06-04 22:09:59', '2012-06-04 22:09:59'),
(14, 1, 'sachin sachin', 'sachin@sachin.com', '2012-06-06 23:41:34', '2012-06-06 23:41:34');
...
DROP PROCEDURE IF EXISTS `cc_getUserPasswordNProfile`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `cc_getUserPasswordNProfile`(email varchar(45),
                                     applicationId int)
BEGIN
    ...
    select professionId into proId
    from cc_userprofile userprofile
    where userprofile.userId = userId;
    
    select specialtyId into specId
    from cc_userprofile userprofile
    where userprofile.userId = userId;
    ...
    select userId,
           ...
           passwordFormat,
           passwordSalt,
           isApproved,profession,specialty
    from cc_membership memb,profession prof,specialty spec
    where memb.userId = userId
    and memb.applicationId = applicationId and prof.professionId = professionId 
    and spec.specialtyId = specialtyId;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `createSubscription`(In userId int(11)
...
DROP PROCEDURE IF EXISTS `createSubscription_`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `createSubscription_`(In email varchar(45)
                                   ,In pwd varchar(45)
                                   ,In appId int(11)
                                   ,In prvSubscriptionId varchar(45)
                                   ,In productId int(11)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllProductSubscriptionsDelta`(
                                                                     IN lastSyncDate datetime
                                                                     )
BEGIN
...
DROP PROCEDURE IF EXISTS `getAllProductSubscriptionsDelta_`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllProductSubscriptionsDelta_`(IN email varchar(45)
                                                                     ,IN appId int(11)
                                                                     ,IN pwd varchar(45)
                                                                     ,IN lastSyncDate datetime
                                                                     )
...
DROP PROCEDURE IF EXISTS `getAllProductSubscriptions_`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllProductSubscriptions_`( 
    IN email varchar (45),
    IN pwd varchar(45),
    IN appId int(11))
BEGIN
...
BEGIN
        ...
        (select name 
    	from authoringorganizations 
    	where authoringOrgId = prod.authoringOrganizationId) as authoringOrganization,
        prod.endorsedBy,prod.price,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUserSubscriptions`(In userId int(11))
BEGIN
...
DROP PROCEDURE IF EXISTS `getUserSubscriptionsDelta`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUserSubscriptionsDelta`(In userId int(11),
                                                          In lastSyncDate datetime)
BEGIN
            ...
            where prd.productID = sub.productId) as title
            FROM Subscriptions sub
            where sub.creationDate >= lastSyncDate and sub.userId = userId;

END$$

DROP PROCEDURE IF EXISTS `getUserSubscriptions_`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUserSubscriptions_`(In email varchar(45),
                                                                         In pwd varchar (45),
                                                                         IN appId int(11)
                                                                         )
BEGIN
